...
function factoryStats(allEntries, factoryCode, start, end) {
...
module.exports = { vendorStats, factoryStats, categoryStats, groupByMonth, summarize, TOP_LEVEL_CATEGORIES };
