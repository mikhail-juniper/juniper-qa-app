...
class ReportPDF {
  ...
  aqlSummary(aql, i18n) {
    ...
    if (aql.isFallback) {
      ...
      this.keyValueGrid([
        [bi(i18n, 'lotSize'), String(aql.lotSize)],
...
async function buildPdf(payload, filesByField, fitsConfig, i18n, overallResult, categoriesConfig) {
  return new Promise((resolve, reject) => {
    try {
      ...
      pdf.keyValueGrid([
        ...
        [bi(i18n, 'lotSize'), payload.lotSize],
      ...
      if (overallResult && overallResult.aql) {
        pdf.aqlSummary(overallResult.aql, i18n);
      }
