...
class ReportPDF {
  ...
  aqlSummary(aql, i18n, recommendation, payload) {
    ...
    if (aql.isPreProduction) {
      ...
      doc.moveDown(0.4);
      // Still show a simple defect count for the record, with no Accept/Reject
      // thresholds since AQL sampling doesn't apply to a hand-checked pre-production sample.
      this.keyValueGrid([
    ...
    this.subheading(bi(i18n, 'actualDeterminationTitle'));
    this.keyValueGrid([
      [bi(i18n, 'actualCount'), String(aql.actualCount)],
